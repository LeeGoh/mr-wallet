...
public class ErrorResponse {
    ...
    public ErrorResponse(List<Field> fields, List<ConstraintViolation> violations) {
        this.fields = fields;
    ...
    public static class ConstraintViolation {
        ...
        public static List<ConstraintViolation> of(Set<jakarta.validation.ConstraintViolation<?>> constraintViolations) {
